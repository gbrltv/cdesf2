...
def test_extract_cases_time_and_trace():
    ...
    case = Case("2")
    case.add_event(
        {"concept:name": "activity1", "time:timestamp": datetime(2015, 5, 10, 8, 5, 30)}
    )
    case.add_event(
        {
            "concept:name": "activity3",
            "time:timestamp": datetime(2015, 5, 10, 9, 33, 52),
        }
    )
    case.add_event(
        {
            "concept:name": "activity2",
            "time:timestamp": datetime(2015, 5, 10, 10, 30, 00),
        }
    )
    case.add_event(
        {
            "concept:name": "activity4",
            "time:timestamp": datetime(2015, 5, 10, 11, 50, 00),
        }
    )
    case_list.append(case)
    ...
    case = Case("3")
    case.add_event(
        {"concept:name": "activity5", "time:timestamp": datetime(2016, 5, 10, 8, 5, 30)}
    )
    case.add_event(
        {
            "concept:name": "activity1",
            "time:timestamp": datetime(2017, 5, 10, 9, 33, 52),
        }
    )
    case.add_event(
        {
            "concept:name": "activity3",
            "time:timestamp": datetime(2018, 5, 10, 10, 30, 00),
        }
    )
    case.add_event(
        {
            "concept:name": "activity4",
            "time:timestamp": datetime(2019, 5, 10, 11, 50, 00),
        }
    )
    case_list.append(case)
